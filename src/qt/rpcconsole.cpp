                                          ...
                                          banTableContextMenu(0)
{
...
#ifndef Q_OS_MAC
    ui->openDebugLogfileButton->setIcon(QIcon(":/icons/export_dark"));
#endif
    ...
    std::string strzNOVAPathCustom = GetArg("-znovabackuppath", "");
    ...
    if(!strzNOVAPathCustom.empty()) {
        ui->wallet_customznovabackuppath->setText(QString::fromStdString(strzNOVAPathCustom));
        ui->wallet_customznovabackuppath_label->setVisible(true);
        ui->wallet_customznovabackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzNOVAPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Novacash RPC console.") + "<br>" +
